            ...
            <div className="lg:col-span-7 px-2 sm:px-0">
              ...
              <div className="mt-8 sm:mt-12">
                <div className="mb-4 sm:mb-6 px-2 sm:px-0">
                  ...
                  <p className="text-base sm:text-lg font-medium text-cyan-800 mb-1">
                    {activeRoute.titel}
                  </p>
                          ...
                          <div className="flex items-start gap-3 sm:gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3 flex-wrap">
                                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-cyan-100 text-cyan-700 flex items-center justify-center flex-shrink-0">
                                  <Icon className="h-4 w-4 sm:h-5 sm:w-5" />
                                </div>
                                <h4 className="font-semibold text-cyan-700 text-base sm:text-lg">
                                  {item.fase}
                                </h4>
                              </div>
