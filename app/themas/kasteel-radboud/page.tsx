  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-rose-50 via-red-50 to-rose-100 py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto text-center px-4">
            <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-rose-800 mb-3 sm:mb-4 leading-tight">
              De Wereld van Kasteel Radboud
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-rose-900 mb-4 sm:mb-6 font-medium px-2">
