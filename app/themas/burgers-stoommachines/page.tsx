...
export default function BurgersEnStoommachinesPage() {
  ...
  const tabs = [
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div>
            <h4 className="font-semibold text-deep-water-blue mb-2 flex items-center">
              <TrainFront className="h-5 w-5 mr-2 text-deep-water-blue" />
              Kernactiviteit
            </h4>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div>
            <h4 className="font-semibold text-deep-water-blue mb-2 flex items-center">
              <Cog className="h-5 w-5 mr-2 text-deep-water-blue" />
              Kernactiviteit
            </h4>
            <div className="space-y-2 text-gray-700">
  ...
  const themeConfig = getThemeConfig('burgers-stoommachines')
          ...
          <div className="grid lg:grid-cols-10 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-7 px-2 sm:px-0">
              ...
              <ThemeTabs 
                ...
                activeColor={getActiveColor('burgers-stoommachines')}
                activeBorderColor={getActiveBorderColor('burgers-stoommachines')}
