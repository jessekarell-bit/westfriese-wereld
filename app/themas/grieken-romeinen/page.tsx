  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-stone-50 via-orange-50 to-stone-100 py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-10">
            ...
            <div className="absolute top-1/4 right-10 w-64 h-64 rounded-full bg-stone-400/10 blur-3xl"></div>
            <div className="absolute bottom-1/4 left-10 w-48 h-48 rounded-full bg-orange-400/10 blur-3xl"></div>
          </div>

          <div className="relative max-w-4xl mx-auto text-center px-4">
            <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-stone-700 mb-3 sm:mb-4 leading-tight">
              De Wereld van Grieken & Romeinen
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-stone-800 mb-4 sm:mb-6 font-medium px-2">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="mt-8 sm:mt-12">
                <div className="mb-4 sm:mb-6">
                  <h3 className="font-serif text-xl sm:text-2xl font-bold text-stone-700 mb-2">
                    De didactische route
                  </h3>
                  <p className="text-base sm:text-lg font-medium text-stone-800 mb-1">
                    {activeRoute.titel}
                  </p>
                ...
                <div className="space-y-3 sm:space-y-4">
                  {activeRoute.fasen.map((item, index) => {
                    ...
                    return (
                      <Card 
                        key={index} 
                        className="border-l-4 border-l-stone-600"
                      >
                        <CardContent className="p-4 sm:p-6 lg:p-8">
                          <div className="flex items-start gap-3 sm:gap-4">
                            {/* Phase number badge */}
                            <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-stone-600 text-white flex items-center justify-center text-base sm:text-lg font-bold shadow-lg">
                              {index + 1}
                            </div>
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3 flex-wrap">
                                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-stone-100 text-stone-700 flex items-center justify-center flex-shrink-0">
                                  <Icon className="h-4 w-4 sm:h-5 sm:w-5" />
                                </div>
                                <h4 className="font-semibold text-stone-700 text-base sm:text-lg">
                                  {item.fase}
                                </h4>
                              </div>
