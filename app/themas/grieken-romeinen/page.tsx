  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-stone-50 via-orange-50 to-stone-100 py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-stone-700 mb-4 leading-tight">
              De Wereld van Grieken & Romeinen
            </h1>
            <p className="text-xl md:text-2xl text-stone-800 mb-6 font-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid lg:grid-cols-10 gap-8">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="mt-12">
                <div className="mb-6">
                  <h3 className="font-serif text-2xl font-bold text-stone-700 mb-2">
                      ...
                      >
                        <CardContent className="p-6 sm:p-8">
                          <div className="flex items-start gap-4">
                            {/* Phase number badge */}
                            <div className="flex-shrink-0 w-12 h-12 rounded-full bg-stone-600 text-white flex items-center justify-center text-lg font-bold shadow-lg">
                              {index + 1}
                            </div>
                            <div className="flex-1">
                              <div className="flex items-center gap-3 mb-3">
                                ...
                                <h4 className="font-semibold text-stone-700 text-lg">
                                  {item.fase}
                                </h4>
                              </div>
                              <p className="text-gray-700 leading-relaxed">
